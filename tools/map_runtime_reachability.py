...
def _classify_module(module: str) -> list[str]:
    ...
    if module in {"emotivus_forge.commands.bind", "emotivus_forge.commands.ledger", "emotivus_forge.commands.protocol", "emotivus_forge.commands.init"}:
    ...
    if leaf in {
        ...
        "truth_ledger", "ref_integrity", "claim_binder", "protocol_verify", "scaffold",
    }:
        values.add("G1_PROJECT_TRUTH")
    if leaf in {
