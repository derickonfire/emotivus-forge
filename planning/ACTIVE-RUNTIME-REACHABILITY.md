...
**Report SHA-256:** `beee6f6130f5f48e364efe441cacac6638cde6ef064b2f1704ba61c15dee1e72`
...
| `docs/` | 63 | yes | yes | REDUCE | REFERENCE, WEB_DOCUMENTATION |
...
| `planning/` | 21 | yes | yes | KEEP | REFERENCE, G3_EVOLUTION_KERNEL |
...
| `tests/` | 115 | yes | yes | KEEP | TESTING |
